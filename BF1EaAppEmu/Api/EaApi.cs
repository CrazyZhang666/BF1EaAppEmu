...
public static class EaApi
{
    ...
    private static readonly string[] _gameTokenAry = ["<GameToken>", "</GameToken>"];
    ...
    /// </summary>
    public static async Task<RespResult> GetAccessToken()
    {
    ...
    public static async Task<RespResult> GetLSXLicense(string requestToken, string contentId)
    {
        ...
        try
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK)
            {
                ...
                var decryptArray = decryptStr.Split(_gameTokenAry, StringSplitOptions.RemoveEmptyEntries);
