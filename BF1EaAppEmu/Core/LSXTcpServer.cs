...
public static class LSXTcpServer
{
    ...
    private static async Task<string> LSXRequestHandleForBFV(string request, string contentId)
    {
        ...
        return requestType switch
        {
            ...
            "><QueryPresence UserId=" => ScoketMsgBFV[13].Replace("##ID##", id).Replace("##UID##", Account.UserId),
            "><SetPresence UserId=" => ScoketMsgBFV[14].Replace("##ID##", id),
            "><GetAllGameInfo version=" => ScoketMsgBFV[27].Replace("##ID##", id).Replace("##SystemTime##", $"{DateTime.Now:s}").Replace("##Locale##", "zh_TW").Replace("##Version##", "1.0.108.2038"),
